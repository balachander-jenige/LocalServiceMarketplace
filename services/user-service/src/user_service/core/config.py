...
class Settings(BaseSettings):
    ...
    LOCAL_MONGODB_URL: str = "mongodb://freelancer:Password123@localhost:27017/user_db"
    DOCKER_MONGODB_URL: str = "mongodb://freelancer:Password123@freelancer-mongodb:27017/user_db"
    
    # Environment selectors / 环境选择器
    USE_LOCAL_MONGODB: bool = False  # 是否使用本地 MongoDB / Whether to use local MongoDB
    ...
    def EFFECTIVE_MONGODB_URL(self) -> str:
        ...
        if self.USE_LOCAL_MONGODB:
            ...
            return self.MONGODB_URL  # 默认使用 MongoDB Atlas / Default to MongoDB Atlas
