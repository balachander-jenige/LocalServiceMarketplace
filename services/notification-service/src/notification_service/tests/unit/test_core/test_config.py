...
class TestSettings:
    ...
    def test_settings_with_env_vars(self, monkeypatch):
        ...
        monkeypatch.setenv("PAYMENT_SERVICE_URL", "http://localhost:8004")
        monkeypatch.setenv("REVIEW_SERVICE_URL", "http://localhost:8005")
        ...
        assert settings.PAYMENT_SERVICE_URL == "http://localhost:8004"
        assert settings.REVIEW_SERVICE_URL == "http://localhost:8005"
    ...
    def test_settings_required_fields(self, monkeypatch):
        ...
        # Also ensure .env file is not read
    ...
    def test_settings_mongodb_url_validation(self, monkeypatch):
        ...
        monkeypatch.setenv("MONGODB_URL", "mongodb://user:pass@localhost:27017/notification_db")
        monkeypatch.setenv("REDIS_URL", "redis://localhost:6379/0")
        monkeypatch.setenv("RABBITMQ_URL", "amqp://guest:guest@localhost:5672/")
        monkeypatch.setenv("AUTH_SERVICE_URL", "http://localhost:8000")
        monkeypatch.setenv("USER_SERVICE_URL", "http://localhost:8002")
        ...
        assert "notification_db" in settings.MONGODB_URL
    ...
    def test_settings_service_urls_override(self, monkeypatch):
        ...
        monkeypatch.setenv("PAYMENT_SERVICE_URL", "http://payment:8004")
        monkeypatch.setenv("REVIEW_SERVICE_URL", "http://review:8005")
        ...
        assert settings.PAYMENT_SERVICE_URL == "http://payment:8004"
        assert settings.REVIEW_SERVICE_URL == "http://review:8005"
    ...
    def test_settings_service_name_custom(self, monkeypatch):
        ...
        monkeypatch.setenv("PAYMENT_SERVICE_URL", "http://localhost:8004")
        monkeypatch.setenv("REVIEW_SERVICE_URL", "http://localhost:8005")
        monkeypatch.setenv("SERVICE_NAME", "custom-notification-service")

        settings = Settings()
        assert settings.SERVICE_NAME == "custom-notification-service"

    def test_settings_env_file_encoding(self, monkeypatch):
        ...
        # Verify settings can be created successfully
